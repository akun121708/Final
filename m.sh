...
cek_reg_mode() {
    until [[ $MYIP =~ ^[0-9.]+$ && ${CLIENT_EXISTS} == '1' ]]; do
        ...
        CLIENT_EXISTS=$(wget -qO- https://raw.githubusercontent.com/akun121708/izinvps/ip | grep -w $MYIP | wc -l)
...
CHATID=$(curl -s https://raw.githubusercontent.com/Mahirmandala/Panel/Panel/Admin)
KEY=$(curl -s https://raw.githubusercontent.com/Mahirmandala/Panel/Panel/Token)
